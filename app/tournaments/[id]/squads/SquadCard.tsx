              ...
              <div className="mb-6">
                <div className="bg-amber-50 border border-amber-200 rounded-md p-4 mb-4">
                  <p className="text-amber-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">You can only reorder positions between your own team members.</span>
                  </p>
                </div>
                <p className="text-gray-700 text-sm">
                  This squad contains athletes from multiple teams. You can only swap positions between athletes from your team.
                </p>
              </div>
